 ...
 * @author mac
 */
public class SpecializeDoctorPanel extends javax.swing.JPanel {
    private final MainFrame mainFrame;
    private final SpecializeDoctorServiceImpl specializeDoctorServiceImpl;
    private String selectedId;
    /**
     * Creates new form SpecializeDoctorPanel
     */
    public SpecializeDoctorPanel(MainFrame mainFrame, SpecializeDoctorServiceImpl specializeDoctorServiceImpl) {
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        this.mainFrame.navigate("dokter");
    ...
    private void getDataTable() {
        ...
        tm.setRowCount(0);
        try {
            List<SpecializeDoctor> specializeList = this.specializeDoctorServiceImpl.findAll();
            for (SpecializeDoctor spe : specializeList) {
                Object[] newRow = {
                    spe.getId(),
                    spe.getName(),
                    spe.getCheckupFee(),
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        // TODO add your handling code here:
        SpecializeDoctor form = new SpecializeDoctor();
        form.setName(SpecializeInput.getText());
        form.setCheckupFee(Double.parseDouble(CostInput.getText()));
        boolean isSaved = false;
        if (selectedId != null) {
            form.setId(selectedId);
            isSaved = specializeDoctorServiceImpl.update(form);
        } else {
            isSaved = specializeDoctorServiceImpl.insert(form);
        }
        if (isSaved) {
            refreshTable();
            resetForm();
    ...
    private void RemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveButtonActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            specializeDoctorServiceImpl.delete(selectedId);
            resetForm();
            refreshTable();
